...
Le kit d'outils Shift peut être téléchargélink:https://mysupport.netapp.com/site/tools/tool-eula/vm-data-collector["ici"] et est disponible uniquement pour les systèmes Windows.
