...
NOTE: Lors de l'utilisation du stockage FlexGroup, seules les conversions au format RAW sont prises en charge. De plus, Shift toolkit injecte les pilotes VirtIO lors de la préparation lorsqu'il effectue des conversions KVM uniquement.
