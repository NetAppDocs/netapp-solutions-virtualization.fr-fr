...
Pour obtenir des instructions détaillées sur la configuration du système, consultez la documentation. link:https://documentation.commvault.com/v11/commcell-console/configuring_netapp_array_using_array_management.html["Configuration de la baie NetApp"] et link:https://documentation.commvault.com/v11/commcell-console/configure_storage_virtual_machine_on_netapp_storage_array.html["Configuration des machines virtuelles de stockage sur les baies NetApp"]
...
Pour les étapes détaillées sur la configuration de la baie, voirlink:https://documentation.commvault.com/2023e/software/guided_setup_for_hyper_v.html["Configuration guidée pour HyperV"] .
...
Pour connaître les étapes détaillées de toutes les options de restauration prises en charge, consultezlink:https://documentation.commvault.com/2023e/software/restores_for_hyper_v.html["Restaurations pour Hyper-V"] .
