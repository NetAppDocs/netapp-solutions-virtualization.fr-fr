...
[role="lead"]
Découvrez NetApp Trident Protect, validé pour la gestion des applications et du stockage persistant pour la solution OpenShift Virtualization.

Trident, un outil de provisionnement et d'orchestration de stockage open source maintenu par NetApp et NetApp Trident Protect vous aide à orchestrer et à gérer les données persistantes dans des environnements basés sur des conteneurs, tels que Red Hat OpenShift.
