...
Pour commencer à utiliser Data Infrastructure Insights, vous pouvez vous inscrire à l'adresse suivante :link:https://www.netapp.com/forms/dii-free-trial/["Essai gratuit de Data Infrastructure Insights"] . Pour plus de détails, veuillez vous référer au link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Data Infrastructure Insights"]
