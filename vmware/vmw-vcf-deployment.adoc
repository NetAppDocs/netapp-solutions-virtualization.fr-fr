...
.. Déployez l'agent de la NetApp Console
+
*** link:https://docs.netapp.com/us-en/console-setup-admin/concept-agents.html["Examinez ce que vous pouvez faire sans agent Console."].
*** link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#overview["Modes de déploiement d'agent"].


.. Utiliser NetApp Backup and Recovery
+
*** link:https://docs.netapp.com/us-en/data-services-backup-recovery/prev-vmware-protect-overview.html["Protégez les charges de travail VM"].
*** link:https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-kubernetes-protect-overview.html["Protégez les charges de travail VKS"].
