...
Pour plus de détails, veuillez consulter link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-hybrid-dr-vmfs.html["Reprise après sinistre avec NetApp Disaster Recovery pour les datastores VMFS"^]
