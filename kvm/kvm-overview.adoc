...
|===
| Protocole de stockage | dir | fs | netfs | logique | disque | iscsi | iscsi-direct 


| chemin mpath | PME/CIFS | Oui | Non | Oui | Non | Non | Non 


| Non | Non | NFS | Oui | Non | Oui | Non | Non 


| Non | Non | Non | iSCSI | Oui | Oui | Non | Oui 


| Oui | Oui | Oui | Oui | FC | Oui | Oui | Non 


| Oui | Oui | Non | Non | Oui | NVMe-oF | Oui | Oui 
|===
