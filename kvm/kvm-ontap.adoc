...
|===
| Protocole de stockage | dir | fs | netfs | logique | disque | iscsi 


| iscsi-direct | chemin mpath | PME/CIFS | Oui | Non | Oui | Non 


| Non | Non | Non | Non | NFS | Oui | Non 
|===
...
[cols="40%, 20,% 20%, 20%"]
|===
| Protocole de stockage | Feutre | Debian 


| Pac-Man | PME/CIFS | samba-client/cifs-utils 


| smbclient/cifs-utils | smbclient/cifs-utils | NFS 


| utilitaires nfs | nfs-commun | utilitaires nfs 
|===
